...
#dataset_list = [('017', '017'), ('018','018'), ('019', '019'), ('020', '020'), ('021', '021'), ('022', '022'), ('023', '023'), ('024', '024')]
dataset_list = [('021', '021')]
#dataset_list = [('MESA', mesa)]
...
for dataset_name, dataset in dataset_list:    
    ...
    distribution_boxplot(X,
                         y,
                         "Initial category 1 distribution of dataset %s" % dataset_name,
                         "Initial category 0 distribution of distribution %s" % dataset_name,
                         #output='show'
                         #output='plotly',
