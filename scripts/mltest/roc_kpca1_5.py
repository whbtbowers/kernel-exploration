...
distribution_boxplot(X,
                     ...
                     output='save',
                     path='../../figs/out/%s/%s/initialdist.png' % (scriptname, dataset),
                     )

print('Boxplot of initial data for dataset %s saved.' % dataset)
...
print('Boxplot of scaled data for dataset %s saved.' % dataset)
